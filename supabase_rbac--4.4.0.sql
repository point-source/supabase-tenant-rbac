...
-- It is not intended to be called by end users directly via RPC. Restricting
-- EXECUTE to the authenticator role prevents anon/authenticated callers from
-- invoking it as an RPC endpoint while still allowing the hook to fire.
