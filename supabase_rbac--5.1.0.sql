...
GRANT EXECUTE ON FUNCTION @extschema@.db_pre_request() TO authenticator, service_role;
...
-- service_role needs SELECT for db_pre_request() when PostgREST switches role
