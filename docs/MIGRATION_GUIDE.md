...
```sql
-- Install v5.x by applying the install migration generated by:
--   tools/install.sh
-- Or manually: copy supabase_rbac--5.2.1.sql, replace @extschema@ with 'rbac',
-- and prepend CREATE SCHEMA IF NOT EXISTS rbac;
```
